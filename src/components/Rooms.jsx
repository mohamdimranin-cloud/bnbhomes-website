...
function RoomCard({ room, index }) {
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow =
          '0 4px 32px rgba(0,0,0,0.4), 0 0 30px rgba(17,104,133,0.2)'
        const shine = e.currentTarget.querySelector('.room-card-shine')
    ...
    >
      {/* Shine line */}
      <div
        className="room-card-shine"
        style={{ opacity: room.featured ? 1 : 0 }}
      />
      ...
      <p style={{ fontSize: '0.9rem', color: '#7ba3b8', lineHeight: 1.6, marginBottom: 20 }}>
        {room.desc}
      </p>
